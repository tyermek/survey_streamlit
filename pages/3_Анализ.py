...
def plot_responses(df, plot_types):
    for plot_type in plot_types:
        if plot_type == "Үйде жұмыс орнының қолжетімділігі":
            ...
            fig.update_layout(width=800, height=600, legend=dict(orientation="h", x=0.5, xanchor="center"))
            st.plotly_chart(fig)
            ...
            fig1.update_layout(xaxis_tickangle=-45, width=800, height=600, legend=dict(orientation="h", x=0.5, xanchor="center"))
            ...
            fig2.update_layout(xaxis_tickangle=-45, width=800, height=600, legend=dict(orientation="h", x=0.5, xanchor="center"))
            ...
            fig.update_layout(xaxis_tickangle=-45, width=800, height=600, legend=dict(orientation="h", x=0.5, xanchor="center"))
