...
def plot_responses(df, plot_types):
    for plot_type in plot_types:
        if plot_type == "Үйде жұмыс орнының қолжетімділігі":
            ...
            fig2 = px.bar(df,
                          x="16.\tКомпьютерде күніне қанша сағат отырасыз? / Сколько часов в день Вы сидите за компьютером?",
                          y="18.\tҚашықтықтан оқыту кезінде гимнастикалық жаттығуды Сіз күніне неше рет жасайсыз? / Сколько раз в день Вы выполняете гимнастическую разминку при дистанционном обучении?",
